...
public class KafkaPublisher0<TKey, TMessage> : IDisposable
    where TMessage : class
    where TKey : class
{
    private readonly IProducer<string, string> _producer;    
    private readonly ILogger<KafkaPublisher0<TKey, TMessage>> _logger;
    private readonly string _topic;

    public KafkaPublisher0(IConfiguration config, ILogger<KafkaPublisher0<TKey, TMessage>> logger)
    {
        _logger = logger;
