...
public class KafkaPublisher1<TKey, TMessage> : IKafkaPublisher<TKey, TMessage>, IDisposable
  where TMessage : class
  where TKey : class
{
    private readonly IProducer<string, string> _producer;
    private readonly ILogger<KafkaPublisher1<TKey, TMessage>> _logger;

    public KafkaPublisher1(IConfiguration config, ILogger<KafkaPublisher1<TKey, TMessage>> logger)
    {
        _logger = logger;
